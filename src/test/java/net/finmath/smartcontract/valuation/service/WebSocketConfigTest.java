...
import net.finmath.smartcontract.valuation.service.websocket.WebSocketConfig;
...
class WebSocketConfigTest {
	...
	void testCreateWebSocketContainer() {
		...
		assertEquals(Integer.valueOf(1024 * 1024), container.getMaxTextMessageBufferSize());
		assertEquals(Integer.valueOf(1024 * 1024), container.getMaxBinaryMessageBufferSize());
	}
