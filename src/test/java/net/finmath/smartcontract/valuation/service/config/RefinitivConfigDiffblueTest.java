...
class RefinitivConfigDiffblueTest {
  ...
  void testGettersAndSetters() {
    ...
    refinitivConfig.setClientId("\"refinitiv_client_123456\"");
    refinitivConfig.setHostName("\"refinitiv-data-platform.finmath.net\"");
    ...
    refinitivConfig.setProxyUser("\"testProxyUser123\"");
    ...
    assertEquals("\"refinitiv-data-platform.finmath.net\"", actualHostName);
    assertEquals("\"refinitiv_client_123456\"", actualClientId);
    assertEquals("\"testProxyUser123\"", actualProxyUser);
