...
import net.finmath.smartcontract.valuation.service.utils.MockResourceGovernor;
...
class DatabaseConnectorDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then calls {@link MockResourceGovernor#getDatabasePropertiesAsResourceInReadMode()}.
   * </ul>
   *
   * <p>Method under test: {@link DatabaseConnector#init()}
   */
  @Test
  @DisplayName("Test init(); then calls getDatabasePropertiesAsResourceInReadMode()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void DatabaseConnector.init()"})
  void testInit_thenCallsGetDatabasePropertiesAsResourceInReadMode()
      throws UnsupportedEncodingException {
    // Arrange
    MockResourceGovernor resourceGovernor = mock(MockResourceGovernor.class);
   ...
   *
   * <ul>
   *   <li>Then calls {@link ResourceGovernor#getDatabasePropertiesAsResourceInReadMode()}.
   * </ul>
   *
   * <p>Method under test: {@link DatabaseConnector#init()}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void DatabaseConnector.init()"})
  void testInit_thenCallsGetDatabasePropertiesAsResourceInReadMode2() {
    // Arrange
    when(resourceGovernor.getDatabasePropertiesAsResourceInReadMode())
