...
class MarketDataCheckTest {
	...
	@Test
	void checkMarketData_emptyMarketData() throws IOException {
		...
		MarketDataList emptyMdl = new MarketDataList();
		Smartderivativecontract sdc = SDCXMLParser.unmarshalXml(fpml, Smartderivativecontract.class);

		MarketDataErrors errors = MarketDataCheck.checkMarketData(emptyMdl, sdc);
