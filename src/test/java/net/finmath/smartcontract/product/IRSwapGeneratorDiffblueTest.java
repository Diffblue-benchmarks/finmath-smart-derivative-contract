...
class IRSwapGeneratorDiffblueTest {
  /**
   * Test {@link IRSwapGenerator#generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String)}.
   * <p>
   * Method under test: {@link IRSwapGenerator#generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String)}
   */
  @Test
  @DisplayName("Test generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String)")
  ...
  void testGenerateAnalyticSwapObject() {
    // Arrange and Act
    Swap actualGenerateAnalyticSwapObjectResult = IRSwapGenerator.generateAnalyticSwapObject(LocalDate.of(1970, 1, 1),
        "42", 10.0d, 10.0d, true, "Forward Curve Name", "3");
   ...
   * Test {@link IRSwapGenerator#generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String)}.
   * <ul>
   *   <li>Then return array length is one hundred sixty-eight.</li>
   * </ul>
   * <p>
   * Method under test: {@link IRSwapGenerator#generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String)}
   */
  @Test
  @DisplayName("Test generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String); then return array length is one hundred sixty-eight")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "Swap IRSwapGenerator.generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String)"})
   ...
   * Test {@link IRSwapGenerator#generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String)}.
   * <ul>
   *   <li>Then return LegPayer DiscountCurveName is empty string.</li>
   * </ul>
   * <p>
   * Method under test: {@link IRSwapGenerator#generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String)}
   */
  @Test
  @DisplayName("Test generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String); then return LegPayer DiscountCurveName is empty string")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "Swap IRSwapGenerator.generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String)"})
  void testGenerateAnalyticSwapObject_thenReturnLegPayerDiscountCurveNameIsEmptyString() {
    // Arrange and Act
    Swap actualGenerateAnalyticSwapObjectResult = IRSwapGenerator.generateAnalyticSwapObject(LocalDate.of(1970, 1, 1),
        "3M", 10.0d, 10.0d, true, "Forward Curve Name", "");
   ...
   * Test {@link IRSwapGenerator#generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String)}.
   * <ul>
   *   <li>Then return LegPayer ForwardCurveName is empty string.</li>
   * </ul>
   * <p>
   * Method under test: {@link IRSwapGenerator#generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String)}
   */
  @Test
  @DisplayName("Test generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String); then return LegPayer ForwardCurveName is empty string")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "Swap IRSwapGenerator.generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String)"})
  void testGenerateAnalyticSwapObject_thenReturnLegPayerForwardCurveNameIsEmptyString() {
    // Arrange and Act
    Swap actualGenerateAnalyticSwapObjectResult = IRSwapGenerator.generateAnalyticSwapObject(LocalDate.of(1970, 1, 1),
        "3M", 10.0d, 10.0d, false, "Forward Curve Name", "3");
   ...
   * Test {@link IRSwapGenerator#generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String)}.
   * <ul>
   *   <li>Then return LegPayer Spreads is array of {@code double} with zero.</li>
   * </ul>
   * <p>
   * Method under test: {@link IRSwapGenerator#generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String)}
   */
  @Test
  @DisplayName("Test generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String); then return LegPayer Spreads is array of double with zero")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "Swap IRSwapGenerator.generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String)"})
  void testGenerateAnalyticSwapObject_thenReturnLegPayerSpreadsIsArrayOfDoubleWithZero() {
    // Arrange and Act
    Swap actualGenerateAnalyticSwapObjectResult = IRSwapGenerator.generateAnalyticSwapObject(LocalDate.of(1970, 1, 1),
        "3M", 10.0d, 10.0d, true, "Forward Curve Name", "3");
   ...
   * <ul>
   *   <li>When {@code 1M}.</li>
   *   <li>Then return LegPayer ForwardCurveName is {@code 1M}.</li>
   * </ul>
   * <p>
   * Method under test: {@link IRSwapGenerator#generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String)}
   */
  @Test
  @DisplayName("Test generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String); when '1M'; then return LegPayer ForwardCurveName is '1M'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "Swap IRSwapGenerator.generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String)"})
   ...
   * <ul>
   *   <li>When {@code 6M}.</li>
   *   <li>Then return LegPayer ForwardCurveName is {@code 6M}.</li>
   * </ul>
   * <p>
   * Method under test: {@link IRSwapGenerator#generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String)}
   */
  @Test
  @DisplayName("Test generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String); when '6M'; then return LegPayer ForwardCurveName is '6M'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "Swap IRSwapGenerator.generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String)"})
   ...
   * Test {@link IRSwapGenerator#generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String)}.
   * <ul>
   *   <li>When ofYearDay two and two.</li>
   * </ul>
   * <p>
   * Method under test: {@link IRSwapGenerator#generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String)}
   */
  @Test
  @DisplayName("Test generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String); when ofYearDay two and two")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "Swap IRSwapGenerator.generateAnalyticSwapObject(LocalDate, String, double, double, boolean, String, String)"})
  void testGenerateAnalyticSwapObject_whenOfYearDayTwoAndTwo() {
    // Arrange and Act
    Swap actualGenerateAnalyticSwapObjectResult = IRSwapGenerator.generateAnalyticSwapObject(LocalDate.ofYearDay(2, 2),
        "3M", 10.0d, 10.0d, true, "Forward Curve Name", "3");
